...
/**
 *  维护项目全局 UI 配置的单例，通过业务项目自己的 HLUIConfigurationTemplate 来为这个单例赋值，而业务代码里则通过 HLUIConfigurationMacros.h 文件里的宏来使用这些值。
 */

@interface HLUIConfiguration : NSObject
...
@property(nonatomic, assign) CGFloat            windowLevelHLUIAlertView;
@property(nonatomic, assign) CGFloat            windowLevelHLUIImagePreviewView;
