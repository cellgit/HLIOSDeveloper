...
@implementation HLUIConfiguration

+ (instancetype)sharedInstance {
    static dispatch_once_t pred;
    static HLUIConfiguration *sharedInstance = nil;
    dispatch_once(&pred, ^{
        sharedInstance = [[HLUIConfiguration alloc] init];
    });
...
//    self.navBarAccessoryViewTypeDisclosureIndicatorImage = [[UIImage qmui_imageWithShape:QMUIImageShapeTriangle size:CGSizeMake(8, 5) tintColor:self.navBarTitleColor] qmui_imageWithOrientation:UIImageOrientationDown];
    ...
    self.windowLevelHLUIAlertView = UIWindowLevelAlert - 4.0;
    self.windowLevelHLUIImagePreviewView = UIWindowLevelStatusBar + 1;
...
- (void)setNavBarTintColor:(UIColor *)navBarTintColor {
    ...
    [HLUIHelper visibleViewController].navigationController.navigationBar.tintColor = _navBarTintColor;
}
...
- (void)setNavBarBarTintColor:(UIColor *)navBarBarTintColor {
    ...
    [HLUIHelper visibleViewController].navigationController.navigationBar.barTintColor = _navBarBarTintColor;
}
...
- (void)setNavBarShadowImage:(UIImage *)navBarShadowImage {
    ...
    [HLUIHelper visibleViewController].navigationController.navigationBar.shadowImage = _navBarShadowImage;
}
...
- (void)setNavBarBackgroundImage:(UIImage *)navBarBackgroundImage {
    ...
    [[HLUIHelper visibleViewController].navigationController.navigationBar setBackgroundImage:_navBarBackgroundImage forBarMetrics:UIBarMetricsDefault];
}
...
- (void)setNavBarTitleFont:(UIFont *)navBarTitleFont {
    ...
    if (self.navBarTitleFont || self.navBarTitleColor) {
        ...
        [HLUIHelper visibleViewController].navigationController.navigationBar.titleTextAttributes = titleTextAttributes;
    }
}
...
//        UINavigationBar *navigationBar = [HLUIHelper visibleViewController].navigationController.navigationBar;
//        
...
- (void)setNavBarBackButtonTitlePositionAdjustment:(UIOffset)navBarBackButtonTitlePositionAdjustment {
    ...
    if (!UIOffsetEqualToOffset(UIOffsetZero, _navBarBackButtonTitlePositionAdjustment)) {
        ...
        [[HLUIHelper visibleViewController].navigationController.navigationItem.backBarButtonItem setBackButtonTitlePositionAdjustment:_navBarBackButtonTitlePositionAdjustment forBarMetrics:UIBarMetricsDefault];
    }
}

- (void)setToolBarTintColor:(UIColor *)toolBarTintColor {
    _toolBarTintColor = toolBarTintColor;
    [HLUIHelper visibleViewController].navigationController.toolbar.tintColor = _toolBarTintColor;
}
...
- (void)setToolBarBarTintColor:(UIColor *)toolBarBarTintColor {
    ...
    [HLUIHelper visibleViewController].navigationController.toolbar.barTintColor = _toolBarBarTintColor;
}
...
- (void)setToolBarBackgroundImage:(UIImage *)toolBarBackgroundImage {
    ...
    [[HLUIHelper visibleViewController].navigationController.toolbar setBackgroundImage:_toolBarBackgroundImage forToolbarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
}
...
//        [[HLUIHelper visibleViewController].navigationController.toolbar setShadowImage:shadowImage forToolbarPosition:UIBarPositionAny];
//    }
//}

- (void)setTabBarTintColor:(UIColor *)tabBarTintColor {
    _tabBarTintColor = tabBarTintColor;
    [HLUIHelper visibleViewController].tabBarController.tabBar.tintColor = _tabBarTintColor;
}
...
- (void)setTabBarBarTintColor:(UIColor *)tabBarBarTintColor {
    ...
    [HLUIHelper visibleViewController].tabBarController.tabBar.barTintColor = _tabBarBarTintColor;
}
...
- (void)setTabBarBackgroundImage:(UIImage *)tabBarBackgroundImage {
    ...
    [HLUIHelper visibleViewController].tabBarController.tabBar.backgroundImage = _tabBarBackgroundImage;
}
...
//        [HLUIHelper visibleViewController].tabBarController.tabBar.shadowImage = shadowImage;
//    }
//}
...
- (void)setTabBarItemTitleColor:(UIColor *)tabBarItemTitleColor {
    ...
    if (_tabBarItemTitleColor) {
        ...
        [[HLUIHelper visibleViewController].tabBarController.tabBar.items enumerateObjectsUsingBlock:^(UITabBarItem * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
