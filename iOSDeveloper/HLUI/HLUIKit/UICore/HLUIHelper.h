...
@protocol HLUIHelperDelegate <NSObject>

@required
- (void)HLUIHelperPrintLog:(nonnull NSString *)log;

@end

@interface HLUIHelper : NSObject

+ (instancetype _Nonnull)sharedInstance;

@property (nullable, nonatomic, weak) id<HLUIHelperDelegate> helperDelegate;

@end


extern NSString *const _Nonnull HLUIResourcesMainBundleName;
extern NSString *const _Nonnull HLUIResourcesQQEmotionBundleName;



@interface HLUIHelper (Bundle)
...
@interface HLUIHelper (DynamicType)
...
@interface HLUIHelper (AudioSession)
...
@interface HLUIHelper (UIGraphic)
...
@interface HLUIHelper (Orientation)
...
@interface HLUIHelper (ViewController)
...
@interface HLUIHelper (UIApplication)
...
extern NSString * __nonnull const HLUISpringAnimationKey;

@interface HLUIHelper (Animation)

+ (void)actionSpringAnimationForView:(nonnull UIView *)view;

@end

@interface HLUIHelper (Log)
